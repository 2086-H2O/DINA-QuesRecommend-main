...
# 新 Q 矩阵的文件名
NEW_Q_MATRIX_FILE = r"C:\Users\User\Documents\Developer 2086\DINA-QuesRecommend-main\LLM_Q_Generate\outputs\4+10_3_results\DINA_Q_Matrix_4+10_3.xlsx"  # 请确保文件在此路径
...
def preprocess_llm_q_matrix(file_path):
    ...
    try:
        ...
        # 2. 自动提取知识点列 (以 'L' 开头的列)
        k_columns = [col for col in df.columns if col.strip().upper().startswith('L')]
